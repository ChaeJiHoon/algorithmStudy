...
public class GetItemRef {
    public static void main(String[] args){
        Solution2 sol = new Solution2();
        int[][] arr = {{1,1,7,4},{3,2,5,5},{4,3,6,9},{2,6,8,8}};
        int[][] arr1 = {{1,1,5,7}};
        System.out.println(sol.solution(arr, 1,3,7,8)/2);
...
class Solution2{
    ...
    public int solution(int[][] rectangle, int characterX, int characterY, int itemX, int itemY) {
        ...
        changeSide(characterX*2, characterY*2, itemX*2, itemY*2);

        return map[itemY*2][itemX*2];
    }
    ...
    static void changeSide(int startX, int startY, int itemX, int itemY){
        ...
        while(!q.isEmpty()){
            ...
            for(int i=0;i<4;i++){
                ...
                if(0>newX || 0>newY || newX>100 || newY>100) continue;
                // 다음 좌표가 1이 아니면 넘어감
